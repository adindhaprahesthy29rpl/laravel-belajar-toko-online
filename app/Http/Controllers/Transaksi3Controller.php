...
class Transaksi3Controller extends Controller
{
    public function show()
    {
        $data = DB::table('transaksi3')
            ...
            ->select('transaksi3.id_transaksi3', 'transaksi3.id_pelanggan3', 'transaksi3.id_petugas3', 'transaksi3.tgl_transaksi')
            ->get();
    ...
    {
       $hapus = Transaksi3::where('id_transaksi3', $id)->delete();
       if($hapus) {
       return Response()->json(['status' => 1]);
    }
       else {
