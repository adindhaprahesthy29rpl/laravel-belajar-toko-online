...
class Detail_Transaksi3Controller extends Controller
{
    public function show()
    {
        $data = DB::table('detail_transaksi3')
            ...
            ->select('detail_transaksi3.id_detail_transaksi3','transaksi3.id_transaksi3', 'transaksi3.tgl_transaksi', 'produk3.nama_produk', 'detail_transaksi3.qty', 'detail_transaksi3.subtotal')
            ->get();
    ...
    {
       $hapus = Detail_Transaksi3::where('id_detail_transaksi3', $id)->delete();
       if($hapus) {
       return Response()->json(['status' => 1]);
    }
       else {
